...
/// Represents a <delete> tag node in the HTML AST.
#[derive(Debug, Clone)]
pub struct DeleteTagNode {
...
impl HtmlAstNode for DeleteTagNode {
    ...
    {
        // Replicates logic from `handle_crud_element` for <delete>
        ...
        quote! { /* <delete> defines a method, no direct SQL output here */ }
    }
} 