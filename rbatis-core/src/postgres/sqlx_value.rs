...
impl<'c> JsonCodec for PgValueRef<'c> {
    fn try_to_json(self) -> crate::Result<serde_json::Value> {
        ...
        match type_string.as_str() {
            ...
            _ => {
                //TODO "JSONPATH","JSONPATH[]","INT8RANGE","INT8RANGE[]","DATERANGE","DATERANGE[]","TSTZRANGE","TSTZRANGE[]","TSRANGE","TSRANGE[]","NUMRANGE","NUMRANGE[]","INT4RANGE","INT4RANGE[]","RECORD","RECORD[]","VARBIT" "VARBIT[]" "BIT" "BIT[]" "TIMETZ" "TIMETZ[]" "INTERVAL[]" "POINT","POINT[],"LSEG","LSEG[]","PATH","PATH[]","BOX","BOX[]","POLYGON","POLYGON[]","LINE","LINE[]","CIRCLE","CIRCLE[]","MACADDR8","MACADDR8[]","MACADDR","MACADDR[]", you can use json to decode this
