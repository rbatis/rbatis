...
* [English-Website](https://rbatis.github.io/rbatis.io/#/README_EN)

* [官网website](https://rbatis.github.io/rbatis.io/)
...
* [example (need to import with Clion)](https://github.com/rbatis/rbatis/tree/master/example/src)
* [example (need to import with Clion)](https://github.com/rbatis/abs_admin)
...
rbatis-core = { version = "1.6.1", features = ["all"]}
rbatis =  { version = "1.6.1" } 
rbatis-macro-driver = { version = "1.6.1" }
...
### baseline benchmark (machine: win10,6 core i7,16GB)
#### 分步骤压测
``` 
...
rbatis-core， Cargo.toml 加入 rbatis-core = "*"
...
## You can support the project using Wechat donation or by simply starring the repo
...
#### 灵感来源于Mybatis,MybatisPlus

[![Build Status](https://travis-ci.org/zhuxiujia/rbatis.svg?branch=master)](https://travis-ci.org/zhuxiujia/rbatis)

![Image text](logo.png)

#### 为什么不选择diesel，sqlx之类的框架?
