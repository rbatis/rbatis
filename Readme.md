...
What is described above occurs during the cargo build phase, which is the compilation phase of the rust procedural macro, where the code generated by ratis -codegen is handed back to the rust compiler for LLVM compilation to produce pure machine code
