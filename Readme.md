...
* Productivity: Powerful ([Interceptor interface](https://github.com/rbatis/rbatis/blob/master/src/plugin/intercept_log.rs)), macro `#[py_sql]` , macro `#[html_sql]` (just like mybatis3),macro `curd!`,  [RBDC driver](https://crates.io/crates/rbdc) ([rbdc-mysql](https://crates.io/crates/rbdc-mysql),[rbdc-pg](https://crates.io/crates/rbdc-pg),[rbdc-sqlite](https://crates.io/crates/rbdc-sqlite) and more),[Table synchronize plugin](https://rbatis.github.io/rbatis.io/#/v4/?id=plugin-table-sync),[abs_admin project](https://github.com/rbatis/abs_admin)
