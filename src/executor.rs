...
impl RBatisConnExecutor {
    pub fn as_executor(&mut self) -> RbatisExecutor<'_> {
...
#[async_trait]
impl ExecutorMut for RBatisConnExecutor {
        ...
        T: DeserializeOwned,
    {
        ...
        return decode(Value::Array(result?));
    }
}
...
#[async_trait]
impl ExecutorMut for RBatisTxExecutor {
